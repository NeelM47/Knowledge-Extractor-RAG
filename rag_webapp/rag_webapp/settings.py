"""
Django settings for rag_webapp project.
...
SECRET_KEY = 'django-insecure-=v=87z@4io0-#=3fj3(_=^$p)=c7muf40!3!&mr%dy+lh4=ty$'
...
WSGI_APPLICATION = 'rag_webapp.wsgi.application'
